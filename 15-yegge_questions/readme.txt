Steve Yegge Coding Test Questions
    ...
    X Write a function to reverse a string.
    X Write function to compute Nth fibonacci number:
    X Print out the grade-school multiplication table up to 12x12
    X Write a function that sums up integers from a text file, one int per line.
    X Write function to print the odd numbers from 1 to 99.
    X Find the largest int value in an int array.
